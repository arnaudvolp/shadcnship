...
const saasCategories = ["waitlist", "table", "dashboard", "confirmation", "authentication", "settings", "onboarding", "notification", "command", "invoice", "file-upload", "activity-feed", "team-management", "kanban", "chat", "calendar", "sidebar"];
